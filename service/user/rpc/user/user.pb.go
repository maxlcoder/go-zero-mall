...
func (x *UserRsp) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
var file_user_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x43, 0x0a, 0x07, 0x55,
	...
	0x1a, 0x0d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x73, 0x70, 0x42,
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 1: user.user.getUser:output_type -> user.UserRsp
...
func (c *userClient) GetUser(ctx context.Context, in *IdReq, opts ...grpc.CallOption) (*UserRsp, error) {
	out := new(UserRsp)
...
type UserServer interface {
	GetUser(context.Context, *IdReq) (*UserRsp, error)
}
...
func (*UnimplementedUserServer) GetUser(context.Context, *IdReq) (*UserRsp, error) {
